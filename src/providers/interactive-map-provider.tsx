...
import {
  ...
  createInteractiveMapStore,
} from '@/stores/interactive-map-store';

export type InteractiveMapStoreApi = ReturnType<typeof createInteractiveMapStore>;

export const InteractiveMapContext = createContext<InteractiveMapStoreApi | undefined>(undefined);
...
export const useInteractiveMapStore = <T,>(selector: (map: InteractiveMapStore) => T): T => {
