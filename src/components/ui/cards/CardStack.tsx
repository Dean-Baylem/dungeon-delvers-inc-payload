    ...
    <div className="w-fit mx-auto max-w-full overflow-x-auto underScrollBar p-4">
      ...
      >
        {list.map((item, index) => (
          ...
          >
            <button
              className="md:flex md:flex-col gap-4 items-center justify-self-center p-4 pb-1 md:pt-4 md:pb-8 md:px-3 md:cursor-pointer md:hover:bg-[#e6c095] md:focus:bg-[#e6c095] duration-150 outline-none w-full"
            ...
            >
              <h3 className="font-subheading font-bold text-xl mx-auto md:mx-0 text-center md:text-end w-fit textmode-sideways">
                {item.title}
              </h3>
            </button>
            <div
