  ...
  return (
    <>
      ...
      <nav
        ref={sideNav}
        id={'side-nav'}
        className={`md:hidden fixed h-full py-20 bg-[rgba(0,0,0,0.9)] top-0 left-0 w-full z-20 overflow-hidden duration-150 opacity-0 ${navOpen ? 'opacity-100' : ''} ${navOpen ? 'pointer-events-auto' : 'pointer-events-none'}`}
      >
